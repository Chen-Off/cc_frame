...
class vCode
{
	...
	private $fontFace = ['simsun.ttc', 'simyou.ttf'];
	...
	private function outputText()
	{
		...
		for ($i = 0; $i < $this->codeNum; $i++) {
			...
			if ($this->chinese) {
				$font = CC_FONTS_PATH.'/'.$this->fontFace[0];
				$fontSize = 16;
				$x = floor(($this->width - 4) / $this->codeNum) * $i + 5;
				$y = 22;
			} else {
				$font = CC_FONTS_PATH.'/'.$this->fontFace[1];
				$fontSize = 20;
				$x = floor($this->width / $this->codeNum) * $i + 3;
				$y = 22;
			}
			$fontColor = imagecolorallocate($this->image, mt_rand(0, 255), mt_rand(0, 255), mt_rand(0, 255));
			imagettftext($this->image, $fontSize, 0, $x, $y, $fontColor, $font, self::msubstr($this->code, $i));
			...
			if ($this->chinese) {
                ...
                imagettftext($this->image, $fontSize, mt_rand(-30, 30), $x, $y, $fontColor, $this->fontFace[0], self::msubstr($this->code, $i));
			} else {
