...
ngApp.controller('AuthContent', ['$scope', '$http', '$sce', '$compile', function ($scope, $http, $sce, $compile) {
    ...
    angular.forEach($scope.f_json_1, function (data) {
        ...
        angular.forEach(data['sub'], function (data_2) {
            ...
            listHtml += '<input name="'+radio_name+'" value="' + lv_2_id + '" type="checkbox" ng-click="changeALL(' + lv_1_id + ', ' + lv_2_id + ')">';
            listHtml += '<i></i>';
            ...
            angular.forEach($scope.f_json_2[data_2['id']], function (data_3) {
                ...
                listHtml += '<label class="i-checks">';
                listHtml += '<input name="'+radio_name+'" value="' + data_3['id'] + '" type="checkbox">';
                listHtml += '<i></i>';
