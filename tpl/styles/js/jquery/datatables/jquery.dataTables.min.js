...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"第一页",sLast:"最后一页",sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"没有数据存在,请检查",sInfo:"总共 _PAGES_ 页 _TOTAL_ 条记录，显示第 _START_ 条 到第 _END_ 条 ",sInfoEmpty:"总共 0 页 0 条记录，显示第 0 条到第 0 条",sInfoFiltered:"(筛选之后得到 _TOTAL_ 条，初始_MAX_ 条)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"显示 _MENU_ 条记录",sLoadingRecords:"加载中...",sProcessing:"处理中...",sSearch:"搜索:",sUrl:"",sZeroRecords:"找不到匹配的数据"},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};S(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,bSortable:!0,bVisible:!0,fnCreatedCell:null,
